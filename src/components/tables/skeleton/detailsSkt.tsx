    ...
    <div className="flex flex-col gap-6">
      {[1, 2].map((el) => (
        <div key={el} className={cn("flex gap-2", { "gap-0": previewMode })}>
          ...
          <div className={cn("flex flex-col md:flex-row gap-2 md:gap-8", { "gap-0": previewMode })}>
            <Skeleton
              className={cn(
      ...
      {previewMode || !isDesktop ? (
        <div className={cn("flex gap-2", { "gap-0": previewMode })}>
          {!previewMode && <Skeleton className="hidden md:block h-12 w-12 shrink-0" />}
          <div className={cn("flex flex-col md:flex-row gap-2 md:gap-8", { "gap-0": previewMode })}>
            <Skeleton
              className={cn(
        ...
        <div className={cn("flex gap-2")}>
          ...
          <div className={cn("flex flex-col md:flex-row gap-2 md:gap-8")}>
            ...
            <div className="w-[542px] h-40 border border-border rounded-md p-4">
